...
import { Trophy, Target, TrendingUp, TrendingDown, Activity, Zap, Wallet, ShieldCheck, History, Loader2, AlertCircle } from "lucide-react";
      ...
      <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-5 flex flex-col gap-3 sm:gap-4">
           ...
           {/* Recent Trades */}
           <div className="glass p-3 sm:p-4 md:p-5 space-y-4">
           ...
           {/* Asset Distribution */}
           <div className="glass p-3 sm:p-4 md:p-5 min-h-[350px]">
             <div className="flex justify-between items-center mb-4">
